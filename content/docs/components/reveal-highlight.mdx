...
<TS>
```npm
npx shadcn@latest add https://abdxdev-cn.vercel.app/r/reveal-highlight-ts.json
```
</TS>
<JS>
```npm
npx shadcn@latest add https://abdxdev-cn.vercel.app/r/reveal-highlight-js.json
```
</JS>
